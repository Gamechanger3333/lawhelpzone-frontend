                ...
                {loadM ? (
                  ...
                  <div key={day}>
                    ...
                    {dayMsgs.map((msg, i) => {
                      ...
                      // ── SKIP ghost messages: old DB records that are just text "Voice message"
                      // with no actual audio data. These are duplicate records from old code.
                      // A real audio msg always has either a data: URL or a server URL with audio ext.
